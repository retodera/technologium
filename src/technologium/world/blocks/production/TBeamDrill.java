...
public class TBeamDrill extends BeamDrill {
    public TextureRegion topRegion2;

    public TBeamDrill(String name) {
        super(name);
    }
    ...
    public void drawPlanRegion(BuildPlan plan, Eachable<BuildPlan> list) {
        ...
        Draw.rect(plan.rotation < 2 ? topRegion2 : topRegion, plan.drawx(), plan.drawy(), plan.rotation * 90);
    }

    public class TBeamDrillBuild extends BeamDrillBuild {
        @Override
        public void draw() {
