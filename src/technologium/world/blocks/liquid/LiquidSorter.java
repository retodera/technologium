...
public class LiquidSorter extends Block{
    ...
    public LiquidSorter(String name){
        ...
        config(Integer[].class, (LiquidSorterBuild tile, Integer[] vals) -> {
            tile.sortItem = vals[0] == -1 ? null : content.liquid(vals[0]);
            tile.invert = vals[1] == 1;
        });
        config(Liquid.class, (LiquidSorterBuild tile, Liquid item) -> {
        ...
        configClear((LiquidSorterBuild tile) -> tile.sortItem = null);
    }
    ...
    public void drawPlanConfigCenter(BuildPlan plan, Object content, String region, boolean cross){
        ...
        Color color = Vars.content.liquid(vals[0]).color;
    ...
    public class LiquidSorterBuild extends Building{
        public boolean invert = false;
        public @Nullable Liquid sortItem;
        ...
        public void handleLiquid(Building source, Liquid item, float amount){
            ...
            if(to.liquids.currentAmount() < to.block.liquidCapacity) to.handleLiquid(this, item, Math.min(amount, to.block.liquidCapacity - to.liquids.currentAmount()));
        }
        ...
        public Building getTileTarget(Liquid item, Building source, boolean flip){
            ...
            if(((item == sortItem) != invert) == enabled) {
                ...
                a.acceptLiquid(this, item);
                boolean bc = b != null && !(b.block.instantTransfer && source.block.instantTransfer) &&
                b.acceptLiquid(this, item);
